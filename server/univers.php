...
<body>
    <a target="_blank" style="color:rgb(0,125,255)" href="https://edeneternal.fandom.com/wiki/">Wiki Eden English (with
        maps and classes)</a>
    <div class="dbMenu">
        <ul>
            <a href="univers.php?data=maps">
                <li><img src="images/maps/S013m.png" />
                    <p style="display:inline-block;width: 48%;height: 24px;"> Régions </p><a
                        href="univers.php?data=worldmap"><img src="images/worldmapIcon.png" class="mapIcon"></a>
                </li>
            </a>
            <a href="univers.php?data=class">
                <li><img src="images/skillIcon/E0013.png" /> Classes</li>
            </a>
            <a href="univers.php?data=videos" class="notranslate">
                <li><img src="images/uiiconPNG/script00.png" />Trailers / Openings</li>
            </a>
        </ul>
    </div>
                    ...
                    <div id="worldmapContainer" class="container">
                        <div class="select3D" style="left:auto;z-index:10;margin:0px;padding:0px;">
                            <ul style="display:flex;margin:0px;padding:0px;">
                                ...
                                <li class="mapMenu activate" data-map=0>Central <img src="images/otherIcon/function026.png"
                                        class="YVES"></li>
                        ...
                        <div class="continent active" id="C0" style="height:600px">
                            ...
                            ?>
                            <img id="worldmap01" src="images/mapworld01-YVES-HD-Final-v2.png"
        ...
        height: auto !important;" src="https://edeneternal.fandom.com/wiki/Class" title="description"></iframe>
            ...
            ?>
                            <div class="flexContainer">
                                <iframe src="https://www.youtube.com/embed/Ks9kTC_vzLQ" title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                                <iframe src="https://www.youtube.com/embed/cp1cKHJw_yA" title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                                <iframe src="https://www.youtube.com/embed/Jr9b2L2_kvM" title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                                <iframe src="https://www.youtube.com/embed/Vf-qP5joSsg" title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
                                <iframe src="https://www.youtube.com/embed/rlHHUMB6HjI" title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                    allowfullscreen></iframe>
            ...
            <script>
                ...
                document.querySelector(".YVES")?.addEventListener('click', e => {
                    if (worldMap01E.src.includes('YVES')) {
                        worldMap01E.src = "images/mapworld013.png";
